...
6. **Ancore no projeto real.** Cite arquivos existentes (`src/components/...`), siga as convenções do [CLAUDE.md](../../../CLAUDE.md) (CSS Modules, Server Components por padrão, sem libs extras, etc.).
